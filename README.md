...
<p align="center">
  <a href="#-tokensave">🇬🇧 English</a> · <a href="#-tokensave-1">🇨🇳 中文</a>
</p>
...
`Linux` · `macOS` (pending test) · `Windows` (pending test) · `WSL`
...
给非 Python 工具用（curl、其他语言、Claude Code 等）：
